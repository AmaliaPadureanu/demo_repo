...
public class StreamExample {
    ...
    public static void main(String[] args) {
        ...
        boolean allGt = myStocks.stream().allMatch(s -> s.getShares() > 100.0);
        ...
        myStocks.stream().filter(s -> s.getShares() > 100.0).forEach(s -> System.out.println(s.getName()));
        ...
        Stream<Stock> sortedByShares = myStocks.stream().sorted(byShares);
