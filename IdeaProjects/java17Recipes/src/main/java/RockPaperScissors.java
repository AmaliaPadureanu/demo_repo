...
public class RockPaperScissors {
    ...
    private static void playHands(int yourHand, int myHand) {
        switch ((yourHand == myHand) ? 0 : (yourHand + myHand)) {
            ...
            break;
            case 3: System.out.println("Paper beats Rock");
            printWinner(yourHand, 2);
            break;
            case 4: System.out.println("Rock beats Scissors");
            printWinner(yourHand, 1);
            break;
            case 5: System.out.println("Scissors beats Paper");
            printWinner(yourHand, 3);
            break;
            default: System.out.println("You cheated");
